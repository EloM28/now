...
<body>
	...
	<div class="account-form">
	 	...
	 	<div class="buttons">
	 		<span class="btn active login-btn">iyinjira</span>
	 		<span class="btn  register-btn">iyandikwa</span>
	 	</div>
	 	<form class="login-form active" method="post" action="">
	 		<h3>iyinjira</h3>
	 		<input type="email" name="mail" placeholder="Injiza meyilu" class="box" required>
	 		<input type="password" name="password" placeholder="Injiza ijambo k'abanga" class="box" required>
	        <div class="flex">
	        	<input type="checkbox" name="" id="remember-me">
	        	<label for="remember-me">unyibuke</label>
	        	<a href="#">Wibagiye ijambo k'abanga?</a>
	        </div> 	
	        <input type="submit" name="log" value="Emeza" class="btn">
	 	</form>
         <?php
		 include("authentificate1.php");
		 echo authenti();
		 ?>
	 	<form class="register-form" action="" method="post">
	 		<h3>Iyandikwa</h3>
			<input type="text" name="nom" placeholder="Injiza Izina" class="box" required>
			 <input type="text" name="prenom" placeholder="Injiza Amatazirano" class="box"required>
	 		<input type="email" name="mail" placeholder="Injiza Meyilu" class="box" required>
 	 		<input type="password" name="password" placeholder="Injiza Ijambo k'abanga" class="box"required>
			<input type="submit" name="register" value="Emeza" class="btnreg">
	 	</form>
		 </div>
		 
		<?php
		include("insertedu1.php");
		echo insertedu();
		?>
...
<section class="home">
	<div class="swiper home-slider">
		...
		<section class="swiper-slide slide" style="background: url(Images/book.jpg) no-repeat;">
			<div class="content">
				<h3>Ivyigwa vyiza muzobironkera hano</h3> 
				<p>Ni ngombwa cane kwita ku murwayi, kandi umurwayi azakurikizwa, ariko iki nico gihe</p>
				<a href="#" class="btn">Gutangura</a>
			</div>
		</section>
